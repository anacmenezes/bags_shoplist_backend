...
import com.shoplist.bags.services.UsersService;
...
public class UsersResource {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody UsersDTO objDto) {
	...
	public ResponseEntity<Void> update(@Valid @RequestBody UsersDTO objDto, @PathVariable Integer id) {
		Users obj = service.fromDTO(objDto);
		obj.setId(id);
